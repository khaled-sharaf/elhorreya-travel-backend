        ...
        <tbody>
            ...
            >
                ...
                <td v-show="tableData.columns.indexOf('actions') != -1" class="actions">
                    ...
                    <!-- show hotel profile -->
                    <btn-view-profile :model="hotel" modelName="marketing_hotel"></btn-view-profile>
                    <!-- ./show hotel profile -->

                    <!-- btn edit row -->
                    <btn-edit :model="hotel" modelName="marketing_hotel"></btn-edit>
                    <!-- ./btn edit row -->

                    <!-- btn delete row -->
                    <btn-delete :model="hotel" modelName="marketing_hotel" @destroyRow="destroyRow(hotel.id)"></btn-delete>
                    <!-- ./btn delete row -->

                    <!-- btn restore row -->
                    <btn-restore :model="hotel" modelName="marketing_hotel" @restoreRow="restoreRow(hotel.id)"></btn-restore>
                    <!-- ./btn restore row -->

                    <!-- btn force delete row -->
                    <btn-force-delete :model="hotel" modelName="marketing_hotel" @forceDeleteRow="forceDeleteRow(hotel.id)"></btn-force-delete>
                    <!-- ./btn force delete row -->
...
export default {
    ...
    data() {
        return {
            ...
            routeCreate: 'create-marketing_hotel',
    ...
    beforeRouteEnter(to, from, next) {
        next(vm => {
            to.meta.title = vm.$t('sidebar.marketing_hotels')
