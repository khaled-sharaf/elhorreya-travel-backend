                ...
                <div class="content-settings-wrapper">
                    ...
                    <main class="content-settings-view">
                        ...
                        <div class="sections-screen-wrapper">
                            ...
                            <section class="screen" v-for="(screen, index) in screenSizes" :class="{'dis-active': !screen.active}">
                                ...
                                <div class="screen-columns">
                                    <div class="column" v-for="column in columns" v-if="column.name != 'select_row' && column.name != 'show_plus'">
                                        <span
                                            class="badge"
                    ...
                    <footer class="footer">
                        <button
                            class="btn btn-success btn-sm btn-save-settings float-left"
                            type="button"
                            @click="saveSettings()"
                        >
                            {{ $t('global.save') }}
...
<script>
    export default {
        ...
        methods: {
            ...
            getSettings() {
                axios.get('/settings/get/' + this.$nameSettingsInDB).then(response => {
