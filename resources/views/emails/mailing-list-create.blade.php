...
<body>
    ...
    <main class="content">
        ...
        <p>
            خدمة القائمة البريدية هى خدمة إرسال كل ماهو جديد إلى بريدك الخاص ليصلك الرحلات والعروض المناسبة لك، بدلا من الدخول بنفسك كل يوم على موقعنا لتطلع بنفسك على كل جديد فنحن حفاظا على وقتك نرسل إليك كل جديد
        </p>
        <br>
        <h4>إذا كنت تريد حقا الإشتراك فى الخدمة اضغط على زر الإشتراك</h4>
        <br>
        <br>
        <a class="btn btn-secondary" href="{{ $data['url'] }}">
           إشتراك
        </a>
    </main>
    <!-- ./content -->
