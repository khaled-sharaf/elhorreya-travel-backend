...
<link href="{{ url('/css/app.944f0c41.css') }}" rel=preload as=style>
<link href="{{ url('/css/chunk-vendors.df2481ae.css') }}" rel=preload as=style>
<link href="{{ url('/js/app.3a3c5ef1.js') }}" rel=preload as=script>
<link href="{{ url('/js/chunk-vendors.e96591c9.js') }}" rel=preload as=script>
<link href="{{ url('/css/chunk-vendors.df2481ae.css') }}" rel=stylesheet>
<link href="{{ url('/css/app.944f0c41.css') }}" rel=stylesheet>
...
<script>function initMapCompany() {
    ...
    <script src="{{ url('/js/app.3a3c5ef1.js') }}"></script>
